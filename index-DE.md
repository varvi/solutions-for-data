...
  <!-- Schritt 6 -->
  <div style="text-align: center; min-width: 200px; max-width: 260px; margin: 10px; padding: 5px; padding: 1.2rem; border: 1px solid #ccc; box-shadow: 1px 1px 4px rgba(0,0,0,0.05); border-radius: 10px; background: #f9f9f9;">
    <h4 style="margin: 4px 0 6px 0;">Schritt 6: Bereitstellung und kontinuierliche Verbesserung</h4>
    <p style="margin: 0;">Wir stellen die Lösung mit der passender Infrastruktur bereit. Bei Dashboards kann dies die Integration mit Ihren aktuellen BI-Tools bedeuten. Für Modelle des maschinellen Lernens können Cloud-Dienste oder Bereitstellungspipelines erforderlich sein.</p>
  </div>
  
...
  <!-- Schritt 7 -->
  <div style="text-align: center; min-width: 200px; max-width: 260px; margin: 10px; padding: 5px; padding: 1.2rem; border: 1px solid #ccc; box-shadow: 1px 1px 4px rgba(0,0,0,0.05); border-radius: 10px; background: #f9f9f9;">
    <h4 style="margin: 4px 0 6px 0;">Schritt 7: Wissenstransfer und Schulung</h4>
    <p style="margin: 0;">Um den langfristigen Erfolg sicherzustellen, bieten wir umfassende Schulungen und Dokumentationen an. Dadurch wird Ihr Team in die Lage versetzt, das System zu pflegen, datengestützte Entscheidungen zu treffen und die von der Lösung generierten Erkenntnisse selbstständig zu nutzen. </p>
  </div>
